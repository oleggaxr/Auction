...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 13 2015 г., 02:58
...
CREATE TABLE IF NOT EXISTS `item` (
  `inum` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `item` (`inum`, `ititle`, `image`, `icategory`, `iprice`, `idate`, `itime`, `iuser`, `istatus`) VALUES
(1, 'Gdsg<br>erwerwer', 'pic.jpg', 'разное', 120.4, '2015-07-12', '14:30:06', 'Борщец', 'active'),
(4, 'Item', '', 'другое', 203, '2015-07-12', '19:28:52', 'Nome', 'completed'),
(5, 'Item2', '', 'категория', 100, '2015-07-12', '19:31:08', 'Имя', 'future');
--
...
('def', 'bd', 'item', 'inum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'ititle', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'image', 3, NULL, 'NO', 'varchar', 120, 360, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(120)', '', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'icategory', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'iprice', 5, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'idate', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'itime', 7, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'iuser', 8, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'bd', 'item', 'istatus', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '1334'),
('HANDLER_READ_KEY', '940'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '75'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '9'),
('HANDLER_READ_RND_NEXT', '18175'),
('HANDLER_ROLLBACK', '11'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '845'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '18328'),
('INNODB_BUFFER_POOL_READS', '0'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '5638'),
('INNODB_DATA_FSYNCS', '267'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '0'),
('INNODB_DATA_READS', '6'),
('INNODB_DATA_WRITES', '1086'),
('INNODB_DATA_WRITTEN', '26759168'),
('INNODB_DBLWR_PAGES_WRITTEN', '672'),
('INNODB_DBLWR_WRITES', '57'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '3712'),
('INNODB_LOG_WRITES', '103'),
('INNODB_OS_LOG_FSYNCS', '148'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '1881088'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '396'),
('INNODB_PAGES_READ', '0'),
('INNODB_PAGES_WRITTEN', '845'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '350725'),
('UPTIME_SINCE_FLUSH_STATUS', '350725');
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'S:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'S:\\usr\\local\\mysql-5.5\\data\\Str.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'S:\\usr\\local\\mysql-5.5\\data\\Str.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'S:\\usr\\local\\mysql-5.5\\data\\Str.err'),
...
('PLUGIN_DIR', 'S:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'S:\\usr\\local\\mysql-5.5\\data\\Str-slow.log'),
...
('def', 'bd', 'itime', 'def', 'bd', 'item', 'itime', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-12 22:58:11', '2015-07-12 22:58:11', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2015-07-12 22:58:11', NULL, NULL, NULL, '', '', NULL),
('def', 'bd', 'item', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 32768, 0, '2015-07-12 16:35:10', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 61, 308, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2015-07-09 08:20:11', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 40, 40, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2015-07-11 21:04:58', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2015-07-09 08:18:19', NULL, NULL, '', '', NULL);
...
(1344, 'root', 'localhost:63135', 'bd', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(1343, 'root', 'localhost:63134', NULL, 'Sleep', 3, '', NULL);
...
('def', 'bd', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '18391'),
('INNODB_BUFFER_POOL_READS', '0'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '5638'),
('INNODB_DATA_FSYNCS', '267'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '350726'),
('UPTIME_SINCE_FLUSH_STATUS', '350726');
...
('def', 'bd', 'item', 0, 'bd', 'itime', 1, 'itime', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bd', 'item', 1, 'bd', 'iprice', 1, 'iprice', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bd', 'item', 1, 'bd', 'inum', 1, 'inum', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-12 22:58:12', '2015-07-12 22:58:12', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2015-07-12 22:58:12', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'bd', 'item', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 32768, 8388608, 6, '2015-07-12 16:35:10', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 61, 308, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2015-07-09 08:20:11', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 40, 40, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2015-07-11 21:04:58', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2015-07-09 08:18:19', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('''suser''@''localhost''', 'def', 'SELECT', 'YES'),
('''suser''@''localhost''', 'def', 'INSERT', 'YES'),
('''suser''@''localhost''', 'def', 'UPDATE', 'YES'),
('''suser''@''localhost''', 'def', 'DELETE', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE', 'YES'),
('''suser''@''localhost''', 'def', 'DROP', 'YES'),
('''suser''@''localhost''', 'def', 'RELOAD', 'YES'),
('''suser''@''localhost''', 'def', 'SHUTDOWN', 'YES'),
('''suser''@''localhost''', 'def', 'PROCESS', 'YES'),
('''suser''@''localhost''', 'def', 'FILE', 'YES'),
('''suser''@''localhost''', 'def', 'REFERENCES', 'YES'),
('''suser''@''localhost''', 'def', 'INDEX', 'YES'),
('''suser''@''localhost''', 'def', 'ALTER', 'YES'),
('''suser''@''localhost''', 'def', 'SHOW DATABASES', 'YES'),
('''suser''@''localhost''', 'def', 'SUPER', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE TEMPORARY TABLES', 'YES'),
('''suser''@''localhost''', 'def', 'LOCK TABLES', 'YES'),
('''suser''@''localhost''', 'def', 'EXECUTE', 'YES'),
('''suser''@''localhost''', 'def', 'REPLICATION SLAVE', 'YES'),
('''suser''@''localhost''', 'def', 'REPLICATION CLIENT', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE VIEW', 'YES'),
('''suser''@''localhost''', 'def', 'SHOW VIEW', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE ROUTINE', 'YES'),
('''suser''@''localhost''', 'def', 'ALTER ROUTINE', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE USER', 'YES'),
('''suser''@''localhost''', 'def', 'EVENT', 'YES'),
('''suser''@''localhost''', 'def', 'TRIGGER', 'YES'),
('''suser''@''localhost''', 'def', 'CREATE TABLESPACE', 'YES'),
...
('localhost', 'suser', '*9F880DA1329B4B497F247AA25727CCDD5F4DD2E0', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
...
('root', '2015-07-09 08:16:21', '{"lang":"ru"}');
